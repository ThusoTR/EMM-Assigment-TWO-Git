...
function integral_result = evaluate_sub_matrix(a_upper, a_lower, p_sin_input, q_sin_input, theta, alpha)
  ...
  if p_sin_input != q_sin_input
    ...
    integral_result_min_limit = (sin((p_sin_input - q_sin_input)*a_lower + theta - alpha))/(2*(p_sin_input - q_sin_input)) - (sin((p_sin_input + q_sin_input)*a_lower + theta + alpha))/(2*(p_sin_input + q_sin_input));   
  else
